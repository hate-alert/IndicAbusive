...
trainData =  pd.read_csv("/content/drive/MyDrive/IndicLang/Kannada/Code-Mixed/kaEn_train.csv")
valData =  pd.read_csv("/content/drive/MyDrive/IndicLang/Kannada/Code-Mixed/kaEn_val.csv")
testData =  pd.read_csv("/content/drive/MyDrive/IndicLang/Kannada/Code-Mixed/kaEn_test.csv")
...
evalMetric(list(testData['label']), list(testData['pred']))
